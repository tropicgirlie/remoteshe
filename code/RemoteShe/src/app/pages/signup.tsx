...
export function Signup() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success("Account created! Welcome to RemoteShe");
      navigate("/admin");
    } catch (error: any) {
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-black text-gray-900 mb-2">
            Join <span className="text-[#6B46C1]">RemoteShe</span>
          </h1>
        ...
        <div className="bg-white border border-gray-200 rounded-2xl shadow-xl p-8">
          <div className="flex items-center justify-center w-12 h-12 bg-purple-100 rounded-xl mb-6">
            <UserPlus className="w-6 h-6 text-[#6B46C1]" />
          </div>
          ...
          <div className="mt-6 text-center text-sm text-gray-500">
            ...
            <Link to="/login" className="text-[#6B46C1] hover:underline font-semibold">
              Sign in
            </Link>
          </div>
        </div>
